            ...
            <div class="invoice">
                ...
                <div class="invoice-header">
                    ...
                    <div class="invoice-to">
                        <small>to</small>
                        <address class="m-t-5 m-b-5">
                            <strong class="text-inverse">{{ $item->user->name }}</strong><br>
                            {{ $item->user->email }}<br>
                        </address>
                    </div>
                    <div class="invoice-date">
                        <small>Invoice</small>
                        <div class="date text-inverse m-t-5">{{ $item->created_at->translatedFormat('d F Y') }}</div>
                        ...
                        <table class="table table-invoice">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="10%">PACKAGE</th>
                                    <th class="text-center" width="10%">MEDIA</th>
                                    <th class="text-right" width="20%">TOPIC</th>
                                    <th class="text-right" width="20%">TIME</th>
                                    <th class="text-right" width="20%">DURATION (H)</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right">{{ $item->topic }}</td>
                                    <td class="text-right">{{ $item->time->translatedFormat('d/m/Y H:i:s') }}
                                    </td>
                        ...
                        <div class="invoice-price-left">
                            <div class="invoice-price-row">
                                <div class="sub-price">
                                    ...
                                    <span class="text-inverse">Rp. {{ number_format($item->cost) }}</span>
                                </div>
                                <div class="sub-price">
