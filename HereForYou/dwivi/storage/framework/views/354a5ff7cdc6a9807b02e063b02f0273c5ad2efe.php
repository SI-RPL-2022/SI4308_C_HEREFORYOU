...
<header class="w3-display-container w3-wide" id="home">
  <img class="w3-image" src="<?php echo e(asset('assets/image/h2.jpg')); ?>" alt="Fashion Blog" width="1600" height="1060">
...
<div class="w3-row-padding w3-padding-64 w3-theme-l1" id="work">
  ...
  <div class="w3-card w3-white " style="height: 600px">
    <img src="<?php echo e(asset('assets/image/hfy1.png')); ?>" alt="Snow" style="height:auto; width:100%">
  ...
  <div class="w3-quarter">
  <div class="w3-card w3-white" style="height: 600px">
    <img src="<?php echo e(asset('assets/image/hfy4.png')); ?>" alt="Lights" style="height:auto; width:100%">
    <div class="w3-container">
  ...
  <div class="w3-quarter">
  <div class="w3-card w3-white" style="height: 600px">
    <img src="<?php echo e(asset('assets/image/hfy3.png')); ?>" alt="Mountains" style="height:auto; width:100%">
    <div class="w3-container">
    ...
    <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
      <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-card text-center" style="height: 500px">
          <img src="<?php echo e(asset('assets/image/t1.jpg')); ?>" alt="John" style="height: 200px; width: auto">
          <div class="w3-container">
            <h3>Tasya Farasya</h3>
      ...
      <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-card text-center" style="height: 500px">
          <img src="<?php echo e(asset('assets/image/t2.jpg')); ?>" alt="Jane" style="height: 200px; width: auto">
          <div class="w3-container">
      ...
      <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-card text-center" style="height: 500px">
          <img src="<?php echo e(asset('assets/image/t3.jpg')); ?>" alt="Mike" style="height: 200px; width: auto">
          <div class="w3-container">
            <h3>Rachel Vennya</h3>
            <p class="w3-opacity">Selebgram</p>
      ...
      <div class="w3-col l3 m6 w3-margin-bottom">
        <div class="w3-card text-center" style="height: 500px">
          <img src="<?php echo e(asset('assets/image/t4.jpg')); ?>" alt="Dan" style="height: 200px; width: auto">
          <div class="w3-container">
            <h3>Keanu Agl</h3>
            <p class="w3-opacity">Selebgram</p>
  ...
  <div class="w3-container w3-padding-64 w3-center" id="team">
    ...
    <div class="w3-quarter">
      <img src="<?php echo e(asset('assets/image/yola.jpeg')); ?>" alt="Boss" style="width:45%" class="w3-circle w3-hover-opacity">
      <h3>Yolanda Hafitzhah</h3>
      <p>1202190057</p>
    </div>
      
    <div class="w3-quarter">
      <img src="<?php echo e(asset('assets/image/salsa.jpeg')); ?>" alt="Boss" style="width:45%" class="w3-circle w3-hover-opacity">
      <h3>Salsabila Safitri</h3>
      <p>1202194217</p>
    </div>

    <div class="w3-quarter">
      <img src="<?php echo e(asset('assets/image/PasFoto.jpeg')); ?>" alt="Boss" style="width:45%" class="w3-circle w3-hover-opacity">
      <h3>Nisrina Hanifah Salsabila</h3>
      <p>1202194306</p>
    </div>
    
    <div class="w3-quarter">
      <img src="<?php echo e(asset('assets/image/ninis.jpg')); ?>" alt="Boss" style="width:45%" class="w3-circle w3-hover-opacity">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SI4308_KELOMPOK09_HERE-FOR-YOU\Tubes-WAD\resources\views/pages/home.blade.php ENDPATH**/ ?>