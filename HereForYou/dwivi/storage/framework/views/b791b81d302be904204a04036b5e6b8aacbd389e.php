...
<div class="container mt-5">
    ...
    <div class="row">
       ...
       <div class="col-md-3">
            <div class="card">
                <img src="<?php echo e($psychologist->photo()); ?>" class="card-img-top" alt="..." style="min-height: 180px">
                <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\Downloads\tubes-wad\tubes-wad\resources\views/pages/consultation/index.blade.php ENDPATH**/ ?>