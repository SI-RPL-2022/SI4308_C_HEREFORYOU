...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.banks.store')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('owner_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('logo')); ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between">
                                <a href="<?php echo e(route('admin.banks.index')); ?>" class="btn btn-warning">Batal</a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\Downloads\tubes-wad\tubes-wad\resources\views/admin/pages/bank/create.blade.php ENDPATH**/ ?>